...
/// Inner row (thumbnail, details, menu) for [ProductMobileCard].
class ProductMobileCardContent extends StatelessWidget {
  const ProductMobileCardContent({super.key, required this.product});
